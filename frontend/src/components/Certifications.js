...
const Certifications = () => {
  ...
  const staticCertifications = [
    {
      _id: '1',
      title: 'Oracle Certified Associate – MySQL Implementation',
      issuer: 'Oracle University',
      date: '2025-07-15',
      credentialId: 'OCA-MYSQL-2025-001',
      description: 'Comprehensive certification demonstrating proficiency in MySQL database implementation, administration, and optimization.',
      skills: ['MySQL Administration', 'Database Design', 'Query Optimization', 'Data Management'],
      certificateUrl: 'https://oracle.com/verify/certificate-id',
      icon: 'oracle',
      verified: true,
    },
    {
      ...
      issuer: 'GitHub',
      date: '2025-06-10',
      credentialId: 'GITHUB-FOUND-2025-002',
      description: 'Certification covering repository management, version control, and collaborative workflows using Git and GitHub.',
      skills: ['Version Control', 'Repository Management', 'Collaborative Workflows', 'Git Commands'],
      certificateUrl: 'https://github.com/verify/certificate-id',
      icon: 'github',
      verified: true,
    },
    {
      ...
      date: '2024-12-20',
      credentialId: 'MERN-DEV-2024-003',
      description: 'Comprehensive course covering MongoDB, Express.js, React, and Node.js for full-stack web development.',
      skills: ['React Development', 'Node.js', 'MongoDB', 'Express.js', 'Full-Stack Development'],
      certificateUrl: 'https://platform.com/verify/certificate-id',
      icon: 'web',
      verified: true,
    },
  ];
